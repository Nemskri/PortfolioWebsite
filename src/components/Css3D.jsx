...
Command: npx gltfjsx@6.1.4 css.gltf --transform
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/img/css.gltf')
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, -1.58]}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          <group position={[20.79, 136.75, 10.17]} rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
            ...
            <mesh geometry={nodes.Object_5.geometry} material={materials['Material.005']} position={[-142.94, -32.75, -5922.87]} rotation={[-Math.PI / 2, Math.PI / 2, 0]} scale={100} />
            <mesh geometry={nodes.Object_10.geometry} material={materials['Material.002']} position={[-182.68, 35.49, 1926.62]} />
          </group>
        </group>
      </group>
    </group>
